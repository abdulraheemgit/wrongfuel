...
const HeroSection = () => {
  const phoneNumber = "+44 7XXX XXX XXX";
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="bg-red-100 border-l-4 border-red-500 p-4 rounded-r-lg inline-flex items-center">
            ...
            <span className="text-red-700 font-semibold">FUEL EMERGENCY? DON'T PANIC!</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 mb-8 max-w-2xl mx-auto border-4 border-red-200">
          <p className="text-lg text-gray-600 mb-2">Call Our Emergency Hotline Now:</p>
          <a 
